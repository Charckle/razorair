...
sql_user = environ.get('DB_USERNAME', "razorair")
sql_passwrd = environ.get('DB_PASSWORD', "razorair123")
sql_db = environ.get('DB_NAME', "razorair")
...
class DBcreate:
    ...
    def create_base_tables():
        ...
        db = DB()
        #set the defaults
        sql_command = f"""ALTER DATABASE razorair CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci"""
        ...
        if not check_table_exists("weather"):
            db = DB()
            sql_command = f"""
            CREATE TABLE `notes` (
            `id` INT NOT NULL AUTO_INCREMENT,
